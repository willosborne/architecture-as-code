...
public class CalmArchitectureSchema {
    ...
    public List<CalmNodeSchema> getNodes() {
        return nodes;
    }

    public List<CalmRelationshipSchema> getRelationships() {
        return relationships;
    }

    public List<CalmFlowSchema> getFlows() {
        return flows;
    }

    public CalmControlsSchema getControls() {
        return controls;
    }

    public JsonNode getMetadataRaw() {
        return metadataRaw;
    }
